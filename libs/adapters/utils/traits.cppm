...
concept CompatibleInputRange_c = Adapter_c<Adapter> && std::ranges::input_range<Range> && requires {
...
concept CompatibleOutputRange_c =
  Adapter_c<Adapter> && std::ranges::output_range<Range, typename Adapter::value_type>;
